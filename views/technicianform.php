...
<div class="box box-primary">
  <div class="box-header with-border">
    <h3 class="box-title"><b>Add Technician</b></h3>
  </div>
  <!-- /.box-header -->
  <!-- form start -->
  <form role="form" action="<?php echo WEB_ROOT; ?>views/process2.php?cmd=create" method="post">
    <div class="box-body">
      ...
      <option value="ref">Refrigerator</option>
		...
		<span class="selectRequiredMsg">Please select Service Type.</span>
		</span>
      </div>
    <!-- /.box-body -->
