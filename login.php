...
<html>
  <head>
    ...
    <link href="./dist/css/login2.css" rel="stylesheet" type="text/css">
  ...
  <body class="hold-transition login-page">
    ...
    <div class="login-box">
      ...
      <div class="login-logo">
        <a href="../../acdc/index.php"><h3>AC-DC Service Center Online Booking System</h3></a>
      </div>

      <div class="login-box-body">
        <h4 class="login-box-msg">Sign in to start your account</h4>
		<?php if($errorMessage != "&nbsp;" ) {?>
        ...
        <form action="" method="post">
          <div class="form-group has-feedback"> <!-- class= imgcontainer -->
		  	<span id="sprytf_name"> 
